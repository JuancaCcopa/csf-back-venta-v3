...
namespace Net.Data.VentaCaja
{
        ...
        public class TicketPDF
        {
            public TicketPDF()
            {
                ...
                myDocument.AddCreator("JUAN GABRIEL CASTILLO TURRUBIATES");
            ...
            //static Font font = new Font(bfCourier, fontSize, iTextSharp.text.Font.NORMAL, Color.Black);
            static Font font = new Font(bfCourier, fontSize, Font.NORMAL);
